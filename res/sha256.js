...
// note: blatantly copy-pasted from https://ss64.com/pass/

/*
 * Configurable variables.
 */
// export const hexcase = 0;  /* hex output format. 0 - lowercase; 1 - uppercase        */ (Unused?)
export const b64pad  = ""; /* base-64 pad character. "=" for strict RFC compliance   *//*
* sha functions
